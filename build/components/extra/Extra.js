...
function (_Component) {
  ...
  function Extra() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(Extra)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(Extra, [{
    ...
    value: function render() {
      ...
      }, "Extra"), _react.default.createElement(_ExtraMenu.default, {
        addOnderdeel: this.addOnderdeel,
        onderdeel: "flesje",
        menuOptions: this.data.flesje
      }), _react.default.createElement(_ExtraMenu.default, {
        addOnderdeel: this.addOnderdeel,
        onderdeel: "fruit",
